...
<head>
    ...
    <title>Laporan Keuangan - 2023 | Dashboard</title>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="#">Hutang</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="#">Tabel Pembelian</a>
                        <a class="collapse-item" href="#">Tabel Penjualan</a>
                        <a class="collapse-item" href="#">Tabel Pembayaran</a>
                        <a class="collapse-item" href="#">Tabel Hutang</a>
                        <a class="collapse-item" href="#">Tabel Piutang</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item active">
                ...
                <div id="collapsePages" class="collapse show" aria-labelledby="headingPages"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="#">Register Akun</a>
                    </div>
                </div>
            </li>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Jefri Anugrah 2023</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
